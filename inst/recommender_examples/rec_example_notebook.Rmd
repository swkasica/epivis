...
#Table data
tab_dat<-input_data(file = system.file("./inst/extdata/", "microreact-project-west-african-ebola-epidemic-data.csv", package = "epivis"),dataType = "table")

#Tree data
tree_dat<-input_data(file = system.file("./inst/extdata/", "microreact-project-west-african-ebola-epidemic-tree.nwk", package = "epivis"),dataType = "tree")

#Genomic data
genomic_dat<-input_data(file = system.file("./inst/extdata/", "ebola.fasta", package = "epivis"),dataType = "dna")
...
## Data Harmonization
```{r}
harmon_obj<-data_harmonization(tab_dat,tree_dat, genomic_dat)
